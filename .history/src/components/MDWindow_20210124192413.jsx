...
`
export const meaningBehindName = `
  ### Meaning Behind Name
...
export const streamOfConsciousness = `
...
function MDWindow() {
  ...
  const [brandStoryIsVisible, setBrandStoryIsVisible] = useState(false)
  ...
  return (
    <>
      ...
      <Draggable>
        <Window chrome height="auto" width="500px" padding="10px">
          <TitleBar title="Name Types" controls />
          <FlexColumn>
      ...
      <Draggable>
        <Window chrome height="auto" width="600px" padding="10px">
          <TitleBar title="Meaning Behind Name" controls />
          <FlexColumn>
      ...
      <Draggable>
        <Window chrome height="auto" width="600px" padding="10px">
          <TitleBar title="Stream of Consciousness" controls />
          <FlexColumn>
      ...
      <Draggable>
        <Window chrome height="auto" width="400px" padding="10px">
          <TitleBar title="Cultural Icons" controls />
          <FlexColumn>
      ...
      <Draggable>
        <Window chrome height="auto" width="400px" padding="10px">
          <TitleBar title="Name Ideas" controls />
          <FlexColumn>
